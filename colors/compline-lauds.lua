-- Lauds: A light colorscheme for dawn and contemplation
-- Monastic minimalism - colors as whispers, not shouts
-- Companion to Compline (dark variant)
...
local colors = {
  ...
  -- Grays (base0-7, inverted for light theme)
  base0 = "#f5f4f2",
  base1 = "#e8e7e3",
  base2 = "#d9d8d4",
  base3 = "#c4c3bf",
